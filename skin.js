...
// Filename: Crystal_Suite-Exterior.ggsk
// Generated 2023-11-10T12:40:50
...
function pano2vrSkin(player,base) {
	...
	player.addVariable('vis_map_close_desktop_3', 2, true);
	player.addVariable('vis_map_close_mobile_3', 2, true);
	player.addVariable('vis_map_3', 2, false);
	player.addVariable('vis_map_close_desktop_4', 2, true);
	player.addVariable('vis_map_close_mobile_4', 2, true);
	player.addVariable('vis_map_4', 2, false);
	player.addVariable('vis_map_close_desktop_5', 2, true);
	player.addVariable('vis_map_close_mobile_5', 2, true);
	player.addVariable('vis_map_5', 2, false);
	player.addVariable('vis_map_close_desktop_6', 2, true);
	player.addVariable('vis_map_close_mobile_6', 2, true);
	...
	player.addVariable('opt_auto_rotate', 2, true);
	player.addVariable('opt_thumbnail', 2, true);
	player.addVariable('opt_Map', 2, true);
	player.addVariable('opt_fullscreen', 2, true);
	player.addVariable('opt_gyro', 2, true);
	player.addVariable('opt_vr', 2, true);
	player.addVariable('pos_zoom', 1, 0);
	player.addVariable('pos_auto_rotate', 1, 0);
	player.addVariable('pos_thumbnail', 1, 0);
	player.addVariable('pos_map_button', 1, 0);
	...
	this.addSkin=function() {
		...
		elHorScrollBg.setAttribute('style', 'position: absolute; left: 0px; bottom: 0px; visibility: hidden; width: 384px; height: 15px; background-color: rgba(128,128,128,1); pointer-events: auto;');
		elHorScrollBg.className='ggskin ggskin_scrollarea_hscrollbg';
		elHorScrollFg = me._thumbnail_menu__horScrollFg = document.createElement('div');
		elHorScrollBg.appendChild(elHorScrollFg);
		elHorScrollFg.className='ggskin ggskin_scrollarea_hscrollfg';
		elHorScrollFg.setAttribute('style', 'position: absolute; left: 0px; top: 0px; visibility: hidden; width: 384px; height: 15px; background-color: rgba(192,192,192,1); pointer-events: auto;');
		...
		el=me._slider=document.createElement('div');
		el.ggId="Slider";
		el.ggDx=0;
		el.ggParameter={ rx:0,ry:0,a:0,sx:1,sy:1 };
		el.ggVisible=true;
		...
		el.setAttribute('style',hs);
		el.style[domTransform + 'Origin']='50% 50%';
		me._slider.ggIsActive=function() {
			if ((this.parentNode) && (this.parentNode.ggIsActive)) {
				return this.parentNode.ggIsActive();
			}
			return false;
		...
		me._slider.logicBlock_position = function() {
			var newLogicStatePosition;
			if (
				((player.getVariableValue('pos_slider') == 9))
			)
			{
				newLogicStatePosition = 0;
			}
			else if (
				((player.getVariableValue('pos_slider') == 8))
			)
			{
				newLogicStatePosition = 1;
			}
			else if (
				((player.getVariableValue('pos_slider') == 7))
			)
			{
				newLogicStatePosition = 2;
			}
			else if (
				((player.getVariableValue('pos_slider') == 6))
			)
			{
				newLogicStatePosition = 3;
			}
			else if (
				((player.getVariableValue('pos_slider') == 5))
			)
			{
				newLogicStatePosition = 4;
			}
			else if (
				((player.getVariableValue('pos_slider') == 4))
			)
			{
				newLogicStatePosition = 5;
			}
			else if (
				((player.getVariableValue('pos_slider') == 3))
			)
			{
				newLogicStatePosition = 6;
			}
			else if (
				((player.getVariableValue('pos_slider') == 2))
			)
			{
				newLogicStatePosition = 7;
			}
			else if (
				((player.getVariableValue('pos_slider') == 1))
			)
			{
			...
			if (me._slider.ggCurrentLogicStatePosition != newLogicStatePosition) {
				me._slider.ggCurrentLogicStatePosition = newLogicStatePosition;
				me._slider.style[domTransition]='left 0s, bottom 0s';
				if (me._slider.ggCurrentLogicStatePosition == 0) {
					this.ggDx = 0;
					me._slider.style.bottom='0px';
					me._slider.ggUpdatePosition(true);
				}
				else if (me._slider.ggCurrentLogicStatePosition == 1) {
					this.ggDx = 16;
					me._slider.style.bottom='0px';
					me._slider.ggUpdatePosition(true);
				}
				else if (me._slider.ggCurrentLogicStatePosition == 2) {
					this.ggDx = 33;
					me._slider.style.bottom='0px';
					me._slider.ggUpdatePosition(true);
				}
				else if (me._slider.ggCurrentLogicStatePosition == 3) {
					this.ggDx = 49;
					me._slider.style.bottom='0px';
					me._slider.ggUpdatePosition(true);
				}
				else if (me._slider.ggCurrentLogicStatePosition == 4) {
					this.ggDx = 66;
					me._slider.style.bottom='0px';
					me._slider.ggUpdatePosition(true);
				}
				else if (me._slider.ggCurrentLogicStatePosition == 5) {
					this.ggDx = 84;
					me._slider.style.bottom='0px';
					me._slider.ggUpdatePosition(true);
				}
				else if (me._slider.ggCurrentLogicStatePosition == 6) {
					this.ggDx = 99;
					me._slider.style.bottom='0px';
					me._slider.ggUpdatePosition(true);
				}
				else if (me._slider.ggCurrentLogicStatePosition == 7) {
					this.ggDx = 115;
					me._slider.style.bottom='0px';
					me._slider.ggUpdatePosition(true);
				}
				else if (me._slider.ggCurrentLogicStatePosition == 8) {
					this.ggDx = 128;
					me._slider.style.bottom='0px';
					me._slider.ggUpdatePosition(true);
				}
		...
		me._slider.ggUpdatePosition=function (useTransition) {
			if (useTransition==='undefined') {
				useTransition = false;
			}
			if (!useTransition) {
		...
		hs='data:image/svg+xml;base64,'+
			''+
			...
			''+
		...
		hs='data:image/svg+xml;base64,'+
			''+
			...
			''+
			...
			''+
		...
		me._enter_vr.logicBlock_position = function() {
			var newLogicStatePosition;
			if (
				((player.getVariableValue('pos_vr') == 0))
			)
			{
				newLogicStatePosition = 0;
			}
			else if (
				((player.getVariableValue('pos_vr') == 1))
			)
			{
				newLogicStatePosition = 1;
			}
			else if (
				((player.getVariableValue('pos_vr') == 2))
			)
			{
				newLogicStatePosition = 2;
			}
			else if (
				((player.getVariableValue('pos_vr') == 3))
			)
			{
				newLogicStatePosition = 3;
			}
			else if (
				((player.getVariableValue('pos_vr') == 4))
			)
			{
				newLogicStatePosition = 4;
			}
			else if (
				((player.getVariableValue('pos_vr') == 5))
			)
			{
				newLogicStatePosition = 5;
			}
			else if (
				((player.getVariableValue('pos_vr') == 6))
			)
			{
				newLogicStatePosition = 6;
			}
			else if (
				((player.getVariableValue('pos_vr') == 7))
			)
			{
				newLogicStatePosition = 7;
			}
			else if (
				((player.getVariableValue('pos_vr') == 8))
			)
			{
				newLogicStatePosition = 8;
			}
		...
		me._slider.appendChild(me._enter_vr);
		...
		me._gyro.logicBlock_position = function() {
			...
			)
			{
				...
				((player.getVariableValue('pos_gyro') == 7))
			)
			{
				newLogicStatePosition = 7;
			}
			...
			if (me._gyro.ggCurrentLogicStatePosition != newLogicStatePosition) {
				...
				if (me._gyro.ggCurrentLogicStatePosition == 0) {
					...
					me._gyro.style.left='33px';
					me._gyro.style.top='0px';
				}
				else if (me._gyro.ggCurrentLogicStatePosition == 2) {
					me._gyro.style.left='65px';
					me._gyro.style.top='0px';
				}
				else if (me._gyro.ggCurrentLogicStatePosition == 3) {
					me._gyro.style.left='98px';
					me._gyro.style.top='0px';
				}
				else if (me._gyro.ggCurrentLogicStatePosition == 4) {
					me._gyro.style.left='131px';
					me._gyro.style.top='0px';
				}
				else if (me._gyro.ggCurrentLogicStatePosition == 5) {
					me._gyro.style.left='164px';
					me._gyro.style.top='0px';
				}
				else if (me._gyro.ggCurrentLogicStatePosition == 6) {
					me._gyro.style.left='197px';
					me._gyro.style.top='0px';
				}
				else if (me._gyro.ggCurrentLogicStatePosition == 7) {
					me._gyro.style.left='230px';
					me._gyro.style.top='0px';
				}
				else {
					me._gyro.style.left='230px';
		...
		me._slider.appendChild(me._gyro);
		...
		me._button_fullscreen.logicBlock_position = function() {
			...
			if (me._button_fullscreen.ggCurrentLogicStatePosition != newLogicStatePosition) {
				...
				me._button_fullscreen.style[domTransition]='left 0s, top 0s';
				if (me._button_fullscreen.ggCurrentLogicStatePosition == 0) {
					me._button_fullscreen.style.left='0px';
					me._button_fullscreen.style.top='0px';
				}
				else if (me._button_fullscreen.ggCurrentLogicStatePosition == 1) {
					me._button_fullscreen.style.left='33px';
					me._button_fullscreen.style.top='0px';
				}
				else if (me._button_fullscreen.ggCurrentLogicStatePosition == 2) {
					me._button_fullscreen.style.left='65px';
					me._button_fullscreen.style.top='0px';
				}
				else if (me._button_fullscreen.ggCurrentLogicStatePosition == 3) {
					me._button_fullscreen.style.left='98px';
					me._button_fullscreen.style.top='0px';
				}
				else if (me._button_fullscreen.ggCurrentLogicStatePosition == 4) {
					me._button_fullscreen.style.left='131px';
					me._button_fullscreen.style.top='0px';
				}
				else if (me._button_fullscreen.ggCurrentLogicStatePosition == 5) {
					me._button_fullscreen.style.left='164px';
					me._button_fullscreen.style.top='0px';
				}
				else if (me._button_fullscreen.ggCurrentLogicStatePosition == 6) {
					me._button_fullscreen.style.left='197px';
					me._button_fullscreen.style.top='0px';
				}
				else {
					me._button_fullscreen.style.left='197px';
		...
		els.className='ggskin ggskin_svg';
		hs='data:image/svg+xml;base64,'+
			''+
		...
		elo.className='ggskin ggskin_svg';
		hs='data:image/svg+xml;base64,'+
			''+
		...
		elo.className='ggskin ggskin_svg';
		hs='data:image/svg+xml;base64,'+
			''+
		...
		me._slider.appendChild(me._button_fullscreen);
		...
		me._projection_buttons.logicBlock_position = function() {
			...
			if (me._projection_buttons.ggCurrentLogicStatePosition != newLogicStatePosition) {
				...
				if (me._projection_buttons.ggCurrentLogicStatePosition == 0) {
					...
					me._projection_buttons.style.left='33px';
					me._projection_buttons.style.top='0px';
				}
				else if (me._projection_buttons.ggCurrentLogicStatePosition == 2) {
					me._projection_buttons.style.left='65px';
					me._projection_buttons.style.top='0px';
				}
				else if (me._projection_buttons.ggCurrentLogicStatePosition == 3) {
					me._projection_buttons.style.left='98px';
					me._projection_buttons.style.top='0px';
				}
				else if (me._projection_buttons.ggCurrentLogicStatePosition == 4) {
					me._projection_buttons.style.left='131px';
					me._projection_buttons.style.top='0px';
				}
				else if (me._projection_buttons.ggCurrentLogicStatePosition == 5) {
					me._projection_buttons.style.left='164px';
					me._projection_buttons.style.top='0px';
				}
				else {
					me._projection_buttons.style.left='164px';
		...
		els.className='ggskin ggskin_svg';
		hs='data:image/svg+xml;base64,'+
			''+
			...
			''+
			''+
			...
			''+
			''+
			''+
			''+
			''+
			''+
			''+
			'';
		...
		hs='data:image/svg+xml;base64,'+
			...
			''+
			''+
			...
			''+
			''+
			''+
			''+
			''+
			''+
			''+
			'';
		...
		me._slider.appendChild(me._projection_buttons);
		...
		me._button_map.logicBlock_position = function() {
			var newLogicStatePosition;
			if (
				((player.getVariableValue('pos_map_button') == 0))
			)
			{
				newLogicStatePosition = 0;
			}
			else if (
				((player.getVariableValue('pos_map_button') == 1))
			)
			{
				newLogicStatePosition = 1;
			}
			else if (
				((player.getVariableValue('pos_map_button') == 2))
			)
			{
				newLogicStatePosition = 2;
			}
			else if (
				((player.getVariableValue('pos_map_button') == 3))
			)
			{
				newLogicStatePosition = 3;
			}
			else if (
				((player.getVariableValue('pos_map_button') == 4))
			)
			{
				newLogicStatePosition = 4;
			}
			...
			if (me._button_map.ggCurrentLogicStatePosition != newLogicStatePosition) {
				me._button_map.ggCurrentLogicStatePosition = newLogicStatePosition;
				me._button_map.style[domTransition]='left 0s, top 0s';
				if (me._button_map.ggCurrentLogicStatePosition == 0) {
					me._button_map.style.left='0px';
					me._button_map.style.top='0px';
				}
				else if (me._button_map.ggCurrentLogicStatePosition == 1) {
					me._button_map.style.left='33px';
					me._button_map.style.top='0px';
				}
				else if (me._button_map.ggCurrentLogicStatePosition == 2) {
					me._button_map.style.left='65px';
					me._button_map.style.top='0px';
				}
				else if (me._button_map.ggCurrentLogicStatePosition == 3) {
					me._button_map.style.left='98px';
					me._button_map.style.top='0px';
				}
				else if (me._button_map.ggCurrentLogicStatePosition == 4) {
					me._button_map.style.left='131px';
					me._button_map.style.top='0px';
				}
				else {
					me._button_map.style.left='131px';
		...
		me._button_map.logicBlock_visible = function() {
			var newLogicStateVisible;
			if (
				((player.getVariableValue('opt_Map') == true))
			)
			{
				newLogicStateVisible = 0;
			}
			...
			if (me._button_map.ggCurrentLogicStateVisible != newLogicStateVisible) {
				me._button_map.ggCurrentLogicStateVisible = newLogicStateVisible;
				me._button_map.style[domTransition]='left 0s, top 0s';
				if (me._button_map.ggCurrentLogicStateVisible == 0) {
					me._button_map.style.visibility=(Number(me._button_map.style.opacity)>0||!me._button_map.style.opacity)?'inherit':'hidden';
					me._button_map.ggVisible=true;
				}
				else {
					me._button_map.style.visibility="hidden";
					me._button_map.ggVisible=false;
				}
			}
		}
		...
		me._button_map.ontouchend=function (e) {
			me.elementMouseOver['button_map']=false;
			me._text_1.logicBlock_visible();
		}
		...
		elo.className='ggskin ggskin_svg';
		hs='data:image/svg+xml;base64,'+
			''+
			...
			''+
		...
		me._text_1.logicBlock_position = function() {
			...
			if (me._text_1.ggCurrentLogicStatePosition != newLogicStatePosition) {
				...
				me._text_1.style[domTransition]='left 0s, top 0s';
				if (me._text_1.ggCurrentLogicStatePosition == 0) {
					this.ggDx = 0;
					me._text_1.style.top='-25px';
					me._text_1.ggUpdatePosition(true);
				}
				else {
					me._text_1.ggDx=0;
					me._text_1.style.top='32px';
					me._text_1.ggUpdatePosition(true);
				}
			}
		}
		...
		me._button_map.appendChild(me._text_1);
		me._slider.appendChild(me._button_map);
		el=me._thumbnail_show_button_show=document.createElement('div');
		els=me._thumbnail_show_button_show__img=document.createElement('img');
		els.className='ggskin ggskin_svg';
		hs='data:image/svg+xml;base64,'+
			''+
		...
		me._thumbnail_show_button_show.logicBlock_position = function() {
			var newLogicStatePosition;
			if (
			...
			if (me._thumbnail_show_button_show.ggCurrentLogicStatePosition != newLogicStatePosition) {
				me._thumbnail_show_button_show.ggCurrentLogicStatePosition = newLogicStatePosition;
				me._thumbnail_show_button_show.style[domTransition]='left 0s, top 0s';
				if (me._thumbnail_show_button_show.ggCurrentLogicStatePosition == 0) {
					me._thumbnail_show_button_show.style.left='0px';
					me._thumbnail_show_button_show.style.top='0px';
				}
				else if (me._thumbnail_show_button_show.ggCurrentLogicStatePosition == 1) {
					me._thumbnail_show_button_show.style.left='33px';
					me._thumbnail_show_button_show.style.top='0px';
				}
				else if (me._thumbnail_show_button_show.ggCurrentLogicStatePosition == 2) {
					me._thumbnail_show_button_show.style.left='65px';
					me._thumbnail_show_button_show.style.top='0px';
				}
				else if (me._thumbnail_show_button_show.ggCurrentLogicStatePosition == 3) {
					me._thumbnail_show_button_show.style.left='98px';
					me._thumbnail_show_button_show.style.top='0px';
				}
				else {
					me._thumbnail_show_button_show.style.left='98px';
		...
		me._thumbnail_show_button_show.logicBlock_visible = function() {
			var newLogicStateVisible;
			if (
			...
			if (me._thumbnail_show_button_show.ggCurrentLogicStateVisible != newLogicStateVisible) {
				me._thumbnail_show_button_show.ggCurrentLogicStateVisible = newLogicStateVisible;
				me._thumbnail_show_button_show.style[domTransition]='left 0s, top 0s';
				if (me._thumbnail_show_button_show.ggCurrentLogicStateVisible == 0) {
					me._thumbnail_show_button_show.style.visibility=(Number(me._thumbnail_show_button_show.style.opacity)>0||!me._thumbnail_show_button_show.style.opacity)?'inherit':'hidden';
					me._thumbnail_show_button_show.ggVisible=true;
				}
				else {
					me._thumbnail_show_button_show.style.visibility="hidden";
					me._thumbnail_show_button_show.ggVisible=false;
				}
			}
		}
		...
		me._slider.appendChild(me._thumbnail_show_button_show);
		...
		me._button_auto_rotate.logicBlock_position = function() {
			var newLogicStatePosition;
			if (
				((player.getVariableValue('pos_auto_rotate') == 0))
			)
			{
				newLogicStatePosition = 0;
			}
			else if (
				((player.getVariableValue('pos_auto_rotate') == 1))
			)
			{
				newLogicStatePosition = 1;
			}
			else if (
				((player.getVariableValue('pos_auto_rotate') == 2))
			)
			{
				newLogicStatePosition = 2;
			}
			...
			if (me._button_auto_rotate.ggCurrentLogicStatePosition != newLogicStatePosition) {
				me._button_auto_rotate.ggCurrentLogicStatePosition = newLogicStatePosition;
				me._button_auto_rotate.style[domTransition]='left 0s, top 0s';
				if (me._button_auto_rotate.ggCurrentLogicStatePosition == 0) {
					me._button_auto_rotate.style.left='0px';
					me._button_auto_rotate.style.top='0px';
				}
				else if (me._button_auto_rotate.ggCurrentLogicStatePosition == 1) {
					me._button_auto_rotate.style.left='33px';
					me._button_auto_rotate.style.top='0px';
				}
				else if (me._button_auto_rotate.ggCurrentLogicStatePosition == 2) {
					me._button_auto_rotate.style.left='65px';
					me._button_auto_rotate.style.top='0px';
				}
				else {
					me._button_auto_rotate.style.left='65px';
		...
		me._button_auto_rotate.logicBlock_visible = function() {
			var newLogicStateVisible;
			if (
				((player.getVariableValue('opt_auto_rotate') == true))
			)
			{
				newLogicStateVisible = 0;
			}
		...
		elo.className='ggskin ggskin_svg';
		hs='data:image/svg+xml;base64,'+
			''+
		...
		elo.className='ggskin ggskin_svg';
		hs='data:image/svg+xml;base64,'+
			''+
		...
		me._slider.appendChild(me._button_auto_rotate);
		...
		me._button_zoom.logicBlock_visible = function() {
			...
			if (me._button_zoom.ggCurrentLogicStateVisible != newLogicStateVisible) {
				...
				me._button_zoom.style[domTransition]='';
		...
		elo.className='ggskin ggskin_svg';
		hs='data:image/svg+xml;base64,'+
			''+
		...
		elo.className='ggskin ggskin_svg';
		hs='data:image/svg+xml;base64,'+
			''+
			...
			''+
		...
		me._slider.appendChild(me._button_zoom);
		me._controller.appendChild(me._slider);
		...
		elVertScrollBg.setAttribute('style', 'position: absolute; right: 0px; top: 0px; visibility: hidden; width: 15px; height: 320px; background-color: rgba(0,0,0,0.12549); pointer-events: auto;');
		elVertScrollBg.className='ggskin ggskin_scrollarea_vscrollbg';
		elVertScrollFg = me._node_scroller__vertScrollFg = document.createElement('div');
		elVertScrollBg.appendChild(elVertScrollFg);
		elVertScrollFg.setAttribute('style', 'position: absolute; left: 0px; top: 0px; visibility: hidden; width: 15px; height: 320px; background-color: rgba(255,255,255,0.25098); pointer-events: auto;');
		...
		el.ggFilter = [];
		el.ggTagTable = [
			{tag:"Inicio",title:"Inicio"},
			{tag:"Exterior",title:"Exteriores"},
			{tag:"Gimnasio",title:"Gimnasio"},
			{tag:"SalonSocial",title:"Salon Social"},
			{tag:"Lobby",title:"Lobby"},
			{tag:"Terraza",title:"Terraza"},
			{tag:"Turco",title:"Turco"},
			];
		...
		els.className='ggskin ggskin_svg';
		hs='data:image/svg+xml;base64,'+
		...
		me._menu_open.appendChild(me._text_2);
		...
		player.addListener('tilesrequested', function() {
			player.setVariableValue('vis_loader_1', false);
		});
		player.addListener('playerstatechanged', function() {
			player.setVariableValue('pos_slider', Number("0"));
			if (
				(
					((player.getVariableValue('opt_zoom') == true))
				)
			) {
				player.setVariableValue('pos_slider', player.getVariableValue('pos_slider') + Number("2"));
			}
			if (
				(
					((player.getVariableValue('opt_auto_rotate') == true))
				...
				player.setVariableValue('pos_slider', player.getVariableValue('pos_slider') + Number("1"));
			}
			if (
				(
					((player.getVariableValue('opt_thumbnail') == true))
			...
			player.setVariableValue('pos_vr', Number("0"));
			if (
				(
					((player.getVariableValue('opt_zoom') == true))
				)
			) {
				player.setVariableValue('pos_vr', player.getVariableValue('pos_vr') + Number("2"));
			}
			if (
				(
					((player.getVariableValue('opt_auto_rotate') == true))
				...
				player.setVariableValue('pos_vr', player.getVariableValue('pos_vr') + Number("1"));
			}
			if (
				(
					((player.getVariableValue('opt_thumbnail') == true))
			...
			player.setVariableValue('pos_map_button', Number("0"));
			if (
				(
					((player.getVariableValue('opt_zoom') == true))
				)
			) {
				player.setVariableValue('pos_map_button', player.getVariableValue('pos_map_button') + Number("2"));
			}
			if (
				(
					((player.getVariableValue('opt_auto_rotate') == true))
				...
				player.setVariableValue('pos_map_button', player.getVariableValue('pos_map_button') + Number("1"));
			}
			if (
				(
					((player.getVariableValue('opt_thumbnail') == true))
			...
			player.setVariableValue('pos_auto_rotate', Number("0"));
			if (
				(
					((player.getVariableValue('opt_zoom') == true))
				)
			) {
				player.setVariableValue('pos_auto_rotate', player.getVariableValue('pos_auto_rotate') + Number("2"));
			}
		});
	};
	...
	function SkinHotspotClass_ht_node(parentScope,hotspot) {
		...
		els.className='ggskin ggskin_svg';
		hs='data:image/svg+xml;base64,'+
		...
		els.className='ggskin ggskin_svg';
		hs='data:image/svg+xml;base64,'+
		...
		me._tt_ht_node.logicBlock_visible = function() {
			...
			if (
				...
				((player.getVariableValue('opt_hotspot_preview_2') == false))
			)
			{
				newLogicStateVisible = 0;
			}
	...
	function SkinCloner_thumbnail_cloner_Class(nodeId, parentScope,ggParent,parameter) {
		...
		els.className='ggskin ggskin_svg';
		hs='data:image/svg+xml;base64,'+
			''+
			...
			''+
			...
			''+
			...
			''+
			...
			''+
	...
	me._slider.logicBlock_position();
	...
	me._button_map.logicBlock_position();
	me._button_map.logicBlock_visible();
	me._thumbnail_show_button_show.logicBlock_position();
	me._thumbnail_show_button_show.logicBlock_visible();
	me._tt_thumbnail_open.logicBlock_text();
	me._button_auto_rotate.logicBlock_position();
	...
	player.addListener('changenode', function(args) { me._loading.logicBlock_visible();me._thumbnail_menu.logicBlock_alpha();me._slider.logicBlock_position();me._enter_vr.logicBlock_position();me._enter_vr.logicBlock_visible();me._gyro.logicBlock_position();me._gyro.logicBlock_visible();me._gyro_on.logicBlock_alpha();me._gyro_off.logicBlock_alpha();me._tt_gyro.logicBlock_text();me._button_fullscreen.logicBlock_position();me._button_fullscreen.logicBlock_visible();me._projection_buttons.logicBlock_position();me._projection_buttons.logicBlock_visible();me._button_map.logicBlock_position();me._button_map.logicBlock_visible();me._thumbnail_show_button_show.logicBlock_position();me._thumbnail_show_button_show.logicBlock_visible();me._tt_thumbnail_open.logicBlock_text();me._button_auto_rotate.logicBlock_position();me._button_auto_rotate.logicBlock_visible();me._stop_rotate_image.logicBlock_visible();me._start_rotate_image.logicBlock_visible();me._tt_rotate_start.logicBlock_text();me._button_zoom.logicBlock_visible();me._menu_background.logicBlock_alpha();me._node_scroller.logicBlock_alpha();me._category_scroller.logicBlock_alpha();me._menu_open.logicBlock_position();me._menu_open.logicBlock_alpha(); });
	player.addListener('configloaded', function(args) { me._thumbnail_menu.logicBlock_position();me._tt_enter_vr.logicBlock_position();me._gyro.logicBlock_visible();me._tt_gyro.logicBlock_position();me._tt_fullscreen.logicBlock_position();me._tt_projection.logicBlock_position();me._text_1.logicBlock_position();me._tt_thumbnail_open.logicBlock_position();me._tt_rotate_start.logicBlock_position();me._tt_zoomout.logicBlock_position();me._tt_zoomin.logicBlock_position(); });
	...
	player.addListener('hastouch', function(args) { me._thumbnail_menu.logicBlock_position();me._tt_enter_vr.logicBlock_position();me._tt_gyro.logicBlock_position();me._tt_fullscreen.logicBlock_position();me._tt_projection.logicBlock_position();me._text_1.logicBlock_position();me._tt_thumbnail_open.logicBlock_position();me._tt_rotate_start.logicBlock_position();me._tt_zoomout.logicBlock_position();me._tt_zoomin.logicBlock_position(); });
	player.addListener('varchanged_opt_loader', function(args) { me._loading.logicBlock_visible(); });
	player.addListener('varchanged_vis_thumbnail_menu', function(args) { me._thumbnail_menu.logicBlock_alpha();me._tt_thumbnail_open.logicBlock_text(); });
	...
	player.addListener('varchanged_pos_slider', function(args) { me._slider.logicBlock_position(); });
	...
	player.addListener('varchanged_pos_vr', function(args) { me._enter_vr.logicBlock_position(); });
	player.addListener('varchanged_opt_vr', function(args) { me._enter_vr.logicBlock_visible(); });
	player.addListener('varchanged_pos_gyro', function(args) { me._gyro.logicBlock_position(); });
	player.addListener('varchanged_opt_gyro', function(args) { me._gyro.logicBlock_visible(); });
	player.addListener('varchanged_opt_fullscreen', function(args) { me._button_fullscreen.logicBlock_visible(); });
	player.addListener('varchanged_pos_fullscreen', function(args) { me._button_fullscreen.logicBlock_position(); });
	player.addListener('varchanged_opt_projection', function(args) { me._projection_buttons.logicBlock_visible(); });
	player.addListener('varchanged_pos_projection', function(args) { me._projection_buttons.logicBlock_position(); });
	player.addListener('varchanged_opt_Map', function(args) { me._button_map.logicBlock_visible(); });
	player.addListener('varchanged_pos_map_button', function(args) { me._button_map.logicBlock_position(); });
	player.addListener('varchanged_opt_thumbnail', function(args) { me._thumbnail_show_button_show.logicBlock_visible(); });
	player.addListener('varchanged_pos_thumbnail', function(args) { me._thumbnail_show_button_show.logicBlock_position(); });
	player.addListener('varchanged_opt_auto_rotate', function(args) { me._button_auto_rotate.logicBlock_visible(); });
	player.addListener('varchanged_pos_auto_rotate', function(args) { me._button_auto_rotate.logicBlock_position(); });
